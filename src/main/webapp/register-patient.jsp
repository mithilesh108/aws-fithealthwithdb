			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarSupport">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/allPatientDetails">Patient
								Details</a></li>
	...
	<div class="page-section">
		<div class="container">
			...
			<form class="contact-form mt-5" method="post"
				action="${pageContext.request.contextPath}/registerPatient">
				<div class="row mb-3">
				...
				<a class="btn btn-primary wow zoomIn" href="${pageContext.request.contextPath}/home.jsp" >Back</a>
			</form>
		</div>
	</div>
