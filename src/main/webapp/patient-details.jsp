...
<title>Fit Health - Medical Center</title>
...
<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8 text-sm">
						<div class="site-info">
							<a href="#"><span class="mai-call text-primary"></span> +00
								123 4455 6666</a> <span class="divider">|</span> <a href="#"><span
								class="mai-mail text-primary"></span> mail@example.com</a>
						</div>
					</div>
				...
				<div class="collapse navbar-collapse" id="navbarSupport">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="#">About
								Us</a></li>
						<li class="nav-item"><a class="nav-link" href="#">Doctors</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="#">News</a></li>
						<li class="nav-item active"><a class="nav-link"
							href="${pageContext.request.contextPath}/allPatientDetails">Patient
								Details</a></li>
	...
	<div class="page-section">
		<div class="container">
			...
			<%-- <p>
				Hi ${fullName}, <br /> Your are registered with Patient No :
				${patientNo}, 
			</p> --%>
			<%String userName=request.getParameter("fullName"); %>
<%if(userName == null || userName.length() == 0){
    out.print("No Patient Details");   
}
else {
	out.print(userName+" Your are registered with Patient No : "+request.getParameter("patientNo")+" kindly keep a note of your Patient No for future reference"); 
} %>
			<hr>
			<div>
				All Patient details <br />
				${patientDetails}
				 <br /> 
				 <a class="btn btn-primary wow zoomIn" href="${pageContext.request.contextPath}/home.jsp">HOME</a>
			</div>
		</div>
	</div>
